...
function activityLabel(tool: string, request: WorkspaceAgentRequest): string {
  ...
  if (tool === 'run_shell') return process.platform === 'win32' ? 'PowerShell' : 'Shell'
